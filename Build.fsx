...
let justBuild() =
    ...
    do
        ...
        DotNet.msbuild (fun o -> { o with MSBuildParams = { o.MSBuildParams with Targets=["Restore";"pack"];Properties = props }}) (root @@ "src\\Fable.Localization\\Fable.Localization.csproj")
